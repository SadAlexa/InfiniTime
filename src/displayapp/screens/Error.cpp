...
Error::Error(System::BootErrors error) {
  ...
  lv_obj_set_style_local_text_color(warningLabel, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, Colors::red);
  ...
  if (error == System::BootErrors::TouchController) {
    lv_label_set_text_static(causeLabel, "Trovato un errore nel touch controller");
  }
  ...
  lv_label_set_text_static(tipLabel, "Se riscontri dei problemi e il tuo dispositivo è sotto garanzia, contatta il venditore");
  ...
  lv_obj_set_style_local_bg_color(btnOk, LV_BTN_PART_MAIN, LV_STATE_DEFAULT, Colors::maroon);
}
